...
const trueStoryChicken = new Food(56, 80, 2, 0, 45, 110, 0, 0, 0, 15);
trueStoryChicken.vitA = 0;
trueStoryChicken.vitC = 0;
trueStoryChicken.ca = 0;
trueStoryChicken.fe = 2;

const horizonOrgAmerican = new Food(19, 60, 4, 2.5, 10, 240, 1, 0, 1, 4);
...
const davesEnglishMuff = new Food(62, 140, 1.5, 0, 0, 300, 26, 3, 2, 6);
...
const kashiChocolate = new Food(61, 210, 1.5, 0, 0, 5, 50, 7, 9, 5);
...
const almondBreezeUnsweetendVanilla = new Food(240, 30, 2.5, 0, 0, 170, 1, 0, 0, 1);
...
const franksBuff = new Food(15, 0, 0, 0, 0, 420, 0, 0, 0, 0);

const greenwiseSpinach = new Food(142, 35, 0, 0, 0, 110, 5, 3, 0, 4);
greenwiseSpinach.vitD = 0;
greenwiseSpinach.ca = 10;
greenwiseSpinach.fe = 20;
greenwiseSpinach.kMg = 790;

const greenwiseSunflowerSeeds = new Food(30, 200, 17, 1, 0, 170, 6, 5, 0, 5);
greenwiseSunflowerSeeds.vitD = 0;
greenwiseSunflowerSeeds.ca = 2;
greenwiseSunflowerSeeds.fe = 6;
// greenwiseSpinach.kMg = 790;??????????? 4%

const tomatoUSDA = new Food(123, 22, 0, 0, 0, 6, 5, 2, 3, 1);
tomatoUSDA.vitD = 0;
tomatoUSDA.ca = 1;
tomatoUSDA.fe = 2;
tomatoUSDA.kMg = 291;

const bananaUSDA = new Food(118, 105, 0, 0, 0, 1, 27, 3, 14, 1);
bananaUSDA.vitD = 0;
bananaUSDA.ca = 6;
bananaUSDA.fe = 1;
bananaUSDA.kMg = 517;
...
const lunch = [
  servingCalculation(trueStoryChicken, 64), 
  horizonOrgAmerican, 
  franksBuff, 
  servingCalculation(tomatoUSDA, 40),
  davesEnglishMuff,
  servingCalculation(greenwiseSpinach, 10),
  kashiChocolate,
  almondBreezeUnsweetendVanilla
]

const snack = [
  servingCalculation(bananaUSDA, 89),
  servingCalculation(greenwiseSunflowerSeeds, 15)
]

console.log(mealCalculation([mealCalculation(breakfast), mealCalculation(lunch), mealCalculation(snack)]))
